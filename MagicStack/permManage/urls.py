...
urlpatterns = patterns('permManage.views',
                       ...
                       url(r'^role/push/event/$', push_role_event, name='push_role_event'),
                       url(r'^role/download/key/$', download_key, name='download_key'),
                       url(r'^role/operator/retry/$', perm_role_retry, name='perm_role_retry'),
